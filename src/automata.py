...
class Automata:
    def __init__(self, name):
        ...
        self.estado_texto = {
            ...
            State("q11"): f"{name} se sienta en la cama y observa atentamente la habitación.  El murmullo se acerca cada vez más, y {name} puede ver una figura oscura moviéndose en la penumbra.  Antes de que pueda reaccionar, la figura se lanza hacia él. La historia toma un giro oscuro y {name} nunca se despierta. ",
            State("q12"): f"{name} se esconde bajo las sábanas, temblando de miedo mientras el murmullo se hace cada vez más fuerte.  Siente una presencia junto a su cama y, de repente, las sábanas son arrancadas violentamente. La historia toma un giro aterrador y {name} nunca se despierta. ",
